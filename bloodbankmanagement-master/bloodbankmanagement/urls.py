...
urlpatterns = [
    ...
    path('admin-hospital-detail/<int:pk>/', views.admin_hospital_detail_view, name='admin-hospital-detail'),
    path('admin-hospital-requests/', views.admin_hospital_requests_view, name='admin-hospital-requests'),
]